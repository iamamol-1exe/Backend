export const schema1 = {
  ...
  SSN: { path: "", default: "" },
  Address: { path:[ "patient.address.street1","patient.address.street","subscriber.address.street1"], default: "" },
  Address2: { path: [ "patient.address.street2","subscriber.address.street2"], default: "" },
  City: { path: [ "patient.address.city","subscriber.address.city"], default: "" },
  State: { path: [ "patient.address.state","subscriber.address.state"], default: "" },
  Zip: { path:  [ "patient.address.zip","subscriber.address.zip"], default: "" },
  ...
  BillingType: { path: "plan.plan_type", default: "" },
